...
function newLoginHandler(blaiseApiClient) {
    var router = express_1.default.Router();
    var loginHandler = new LoginHandler(blaiseApiClient);
    router.get("/api/login/users/:user", loginHandler.GetUser);
    router.post("/api/login/users/password/validate", loginHandler.ValidatePassword);
    return router;
}
exports.default = newLoginHandler;
var LoginHandler = /** @class */ (function () {
    function LoginHandler(blaiseApiClient) {
